...
INSERT INTO change_result (result_code, label, retry) VALUES ('CANNOT_REMOVE_SAFELY', 'Cannot safely remove student from group as it appears to be in use already.', '0');
