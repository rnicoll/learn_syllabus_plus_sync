...
CREATE TABLE activity_parents (
    ID VARCHAR(32) NOT NULL,
    PARENT_ACTS VARCHAR(32) NOT NULL,
    OBSOLETEFROM INTEGER DEFAULT NULL,
    LATESTTRANSACTION INTEGER DEFAULT NULL,
    CONSTRAINT parent_activity FOREIGN KEY (ID) REFERENCES ACTIVITY (ID),
    CONSTRAINT parent_parent FOREIGN KEY (PARENT_ACTS) REFERENCES ACTIVITY (ID)
);
