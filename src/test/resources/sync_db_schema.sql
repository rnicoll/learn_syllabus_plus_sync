...
CREATE TABLE module (
    ...
    learn_course_code VARCHAR(106) DEFAULT NULL,
...
CREATE TABLE module_course (
    ...
    learn_course_code VARCHAR(106) NOT NULL,
...
CREATE VIEW jta_parent_activity_group_vw AS 
  (SELECT ag.activity_group_id, a.tt_activity_id, a.tt_activity_name,
            a.learn_group_name, a.description, a.tt_type_id, a.tt_template_id,
            ag.learn_group_id, ag.learn_group_created, mc.learn_course_id
        FROM sync_activity_vw a
...
CREATE VIEW activity_group_vw AS 
  (SELECT ag.activity_group_id, a.tt_activity_id, a.tt_activity_name,
            a.learn_group_name, a.description, a.tt_type_id, a.tt_template_id,
            ag.learn_group_id, ag.learn_group_created, mc.learn_course_id
        FROM sync_activity_vw a
...
CREATE VIEW jta_parent_child_vw AS
