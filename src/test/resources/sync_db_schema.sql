...
CREATE GLOBAL TEMPORARY TABLE activity (
...
CREATE GLOBAL TEMPORARY TABLE synchronisation_run (
...
CREATE GLOBAL TEMPORARY TABLE cache_enrolment (
...
CREATE GLOBAL TEMPORARY TABLE change_result (
...
CREATE GLOBAL TEMPORARY TABLE change_type (
  change_type VARCHAR(12) NOT NULL,
  PRIMARY KEY (change_type)
);

CREATE GLOBAL TEMPORARY TABLE student_set (
  tt_student_set_id VARCHAR(32) NOT NULL,
...
CREATE GLOBAL TEMPORARY TABLE enrolment_change (
